...
func (ec *executionContext) field_Mutation_upsertCharacter_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCharacterInput2graphqlᚑdemoᚋgraphᚋmodelᚐCharacterInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Query_characters_argsCliqueType(
	...
	if tmp, ok := rawArgs["cliqueType"]; ok {
		return ec.unmarshalNCliqueType2graphqlᚑdemoᚋgraphᚋmodelᚐCliqueType(ctx, tmp)
	}
...
func (ec *executionContext) _Character_cliqueType(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCliqueType2graphqlᚑdemoᚋgraphᚋmodelᚐCliqueType(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_upsertCharacter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCharacter2ᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_character(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_characters(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Character)
	fc.Result = res
	return ec.marshalOCharacter2ᚕᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacterᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCharacterInput(ctx context.Context, obj any) (model.CharacterInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "cliqueType":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("cliqueType"))
			data, err := ec.unmarshalNCliqueType2graphqlᚑdemoᚋgraphᚋmodelᚐCliqueType(ctx, v)
			if err != nil {
				return it, err
			}
			it.CliqueType = data
...
func (ec *executionContext) marshalNCharacter2graphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v model.Character) graphql.Marshaler {
	return ec._Character(ctx, sel, &v)
}

func (ec *executionContext) marshalNCharacter2ᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNCharacterInput2graphqlᚑdemoᚋgraphᚋmodelᚐCharacterInput(ctx context.Context, v any) (model.CharacterInput, error) {
	res, err := ec.unmarshalInputCharacterInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNCliqueType2graphqlᚑdemoᚋgraphᚋmodelᚐCliqueType(ctx context.Context, v any) (model.CliqueType, error) {
	var res model.CliqueType
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCliqueType2graphqlᚑdemoᚋgraphᚋmodelᚐCliqueType(ctx context.Context, sel ast.SelectionSet, v model.CliqueType) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalOCharacter2ᚕᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacterᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCharacter2ᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOCharacter2ᚖgraphqlᚑdemoᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Character(ctx, sel, v)
